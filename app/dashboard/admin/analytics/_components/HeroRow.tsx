...
export function HeroRow({ heroStats }: { heroStats: HeroStats }) {
  ...
  return (
    <section className="grid grid-cols-2 gap-2.5">
      ...
      <HeroTile label="Active players (30d)" value={heroStats.active_players_30d.current.toLocaleString()}>
        <MovementLabel
          current={heroStats.active_players_30d.current}
          previous={heroStats.active_players_30d.previous}
          compareLabel="vs prior 30d"
        />
      </HeroTile>
