-- Add ever_signed_in count to analytics_platform_stats for migration progress tracking.
-- "Migrated" = approved user who has signed into the new app at least once.
...
begin
  select jsonb_build_object(
    ...
    -- Approved users who have signed into the new app at least once
