      ...
      >
        ...
        {!isPremium && (
          <Link href="/dashboard/coach/premium" onClick={onClose}
            ...
            style={{ background: 'linear-gradient(135deg, rgba(45,95,196,0.2) 0%, rgba(45,95,196,0.08) 100%)', border: '1px solid rgba(45,95,196,0.45)', textDecoration: 'none' }}>
            <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#3a6fda" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
              <polygon points="12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2" />
            </svg>
            <div className="flex-1 min-w-0">
              <p className="text-sm font-bold" style={{ color: '#3a6fda' }}>Coach Pro</p>
              <p className="text-xs" style={{ color: '#8892aa' }}>£9.99/month · Recruit faster</p>
            </div>
            <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="#3a6fda" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        ...
        <nav className="flex-1 overflow-y-auto px-4 py-2 space-y-1">
          <Link href="/dashboard/coach/players" onClick={onClose}
          ...
          <div className="flex items-center gap-3 px-4 py-3 rounded-xl">
            ...
            <div className="flex-1 min-w-0">
              ...
              <p className="text-xs" style={{ color: emailOptOut ? '#4b5563' : '#8892aa' }}>
                {emailOptOut ? 'Unsubscribed' : 'Weekly digest & player activity'}
              </p>
            </div>
            <button
          ...
          {isAdmin && (
            <>
              ...
              <Link href="/dashboard/admin/broadcast" onClick={onClose}
                className="flex items-center gap-3 px-4 py-3 rounded-xl transition-all"
                style={{ textDecoration: 'none', color: '#f59e0b' }}>
                <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
                ...
                <p className="text-sm font-semibold">Email Composer</p>
              </Link>
              <Link href="/dashboard/admin/test-email" onClick={onClose}
                className="flex items-center gap-3 px-4 py-3 rounded-xl transition-all"
                style={{ textDecoration: 'none', color: '#f59e0b' }}>
                <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
